...
export function ResourceState({
  ...
  return (
    <View accessibilityRole={kind === "error" ? "alert" : undefined} style={styles.container}>
...
const styles = StyleSheet.create({
  container: { gap: spacing.compact, padding: spacing.standard },
  ...
  retryText: { color: colors.brandBlue, fontSize: 16, fontWeight: "700" }
});
